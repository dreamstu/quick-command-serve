...
var confs = {
    ...
    rules : function(pathname){//执行wrap条件，用户可覆盖此默认配置
        return pathname.indexOf('static/page')!=-1;
    },
...
module.exports = initServer = function(quick,opts){
    var exports = {};

    confs = quick.util.merge(opts || {},confs);

    var $mine = confs.mine;
    var $expires = confs.expires;
    var $rules = confs.rules;
    var $transfer = confs.transfer;
    var $basePath = (confs.root!=''?confs.root:confs.serve.root || process.cwd());
